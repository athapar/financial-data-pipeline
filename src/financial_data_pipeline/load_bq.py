...
def load_parquet_to_bigquery(parquet_path: Path, bq_table_: str, project_id: str, symbol: str, mode: str="WRITE_APPEND") -> None:
    ...
    job.result()
    print(f"Loaded {len(df)} rows to {bq_table_}")
